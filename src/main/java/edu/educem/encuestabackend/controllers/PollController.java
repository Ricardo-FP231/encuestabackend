...
import edu.educem.encuestabackend.models.responses.CreatedPollRest;
import edu.educem.encuestabackend.models.responses.PaginatedPollRest;
import edu.educem.encuestabackend.models.responses.PollRest;
import edu.educem.encuestabackend.models.responses.PollResultWrapperRest;
import edu.educem.encuestabackend.services.PollService;
import edu.educem.encuestabackend.utils.transformer.PollResultTransformer;
...
public class PollController {
    ...
    @PostMapping
    public CreatedPollRest createPoll(@RequestBody @Valid PollCreationRequestModel pollCreationRequestModel,
    ...
    public PollRest getPollWithCuestions(@PathVariable String id) {
    ...
    public PaginatedPollRest getPolls(@RequestParam(value = "page", defaultValue = "0") int page,
        ...
        paginatedPollRest.setTotalRecord(paginatedPolls.getTotalElements());
